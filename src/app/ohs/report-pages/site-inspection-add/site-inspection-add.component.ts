...
@Component({
  selector: 'ngx-site-inspection-add',
  templateUrl: './site-inspection-add.component.html',
  styleUrls: ['./site-inspection-add.component.scss'],
})
export class SiteInspectionAddComponent implements OnInit {
  keywordSite = 'name';
  ...
  saveSiteInspection() {
    ...
    this.inspectionService.createSiteInspection( payload)
      .subscribe(
        () => {
          this.showToast('You have successfully added the Site Inspection', 'success');
        },
